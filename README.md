...
```
cd existing_repo
git remote add origin https://gitlab.com/dojo-cp/dojo-cicd-devops.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dojo-cp/dojo-cicd-devops/-/settings/integrations)
